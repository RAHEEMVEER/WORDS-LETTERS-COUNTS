...
console.log(chalk.green.italic.bold(`\t\t     " WELLCOME TO WORD OR LETTER COUNTER: "`));
console.log(chalk.yellow(`\t\t==============================================\n`));
while (loop) {
    ...
    if (userInput.choice === "WORD COUNTER:") {
        ...
        while (wordContinue) {
            ...
            console.log(chalk.yellow(`\t\t      YOU WRITE: `) +
        ...
        while (letterContinue) {
            ...
            console.log(chalk.yellow(`\n\t\t==============================================`));
            console.log(chalk.green.italic.bold(`\t\t     YOU WRITE: `) +
        ...
        console.log(chalk.yellow.italic.bold `\t\t\t  THANKS FOR USING: "GOOD BYE!!"`);
        console.log(chalk.red.italic.bold(`\t\t\t   CREATOR BYE :` + chalk.blue(` "RAHEEM VEER"`)));
        console.log(chalk.green(`\t\t==============================================\n`));
        break;
    }
}
